...
class CreateTableAction(Action):
    ...
    def execute(self):
        ...
        if self.table_data:
            ...
            gui_interface.update_table_data(column_count=len(self.table_data[0]),
    ...
    def __get_table_data(self):
        ...
        if table_type is DatabaseTableTypes.CURRENTS_TABLE:
            ...
            self.table_data = data = session.query(CurrentsDataFrame.time,
        ...
        # Bus Voltages table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(BusVoltagesDataFrame.time,
        ...
        # Temperatures Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(TemperaturesDataFrame.time,
        ...
        # Batteries Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(BatteryDataFrame.time,
        ...
        # Master Motor Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(DriverMasterMCDataFrame.time,
        ...
        # Slave Motor Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(DriverSlaveMCDataFrame.time,
        ...
        # Lights Status Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(LightsDataFrame.time,
        ...
        # Switches Status Table
            ...
            # Return table data as a list of tuples
            self.table_data = data = session.query(SwitchesDataFrame.time,
